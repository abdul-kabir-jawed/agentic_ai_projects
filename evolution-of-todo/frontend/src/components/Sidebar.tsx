...
const navItems = [
  ...
  { href: '/profile', icon: 'lucide:user', label: 'Profile' },
];
    ...
    <nav className="hidden md:flex w-72 flex-col glass-panel border-r border-white/5 relative">
      ...
      <div className="p-8 pb-4">
        ...
        <Link href="/landing" className="flex items-center gap-3 mb-6 group">
          ...
          <div>
            <span className="font-serif font-bold text-lg tracking-tight text-text-primary block">Evolution</span>
            <span className="text-[10px] tracking-widest uppercase text-text-tertiary">of Todo</span>
          </div>
        </Link>
      ...
      <div className="mt-auto p-8 pt-0">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xs font-medium text-text-tertiary uppercase tracking-widest">Daily Progress</h3>
              <div className="flex items-center gap-1">
                <Icon icon="lucide:flame" className="w-4 h-4 text-gold fire-animated" />
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 gap-3 mt-4">
          <div className="glass-card-static p-3 rounded-lg text-center">
            <p className="text-lg font-serif font-medium text-text-primary">{totalCount - completedCount}</p>
            <p className="text-[10px] text-text-tertiary uppercase tracking-wider">Remaining</p>
          </div>
          <div className="glass-card-static p-3 rounded-lg text-center">
            <p className="text-lg font-serif font-medium text-gold">{completedCount}</p>
            <p className="text-[10px] text-text-tertiary uppercase tracking-wider">Done</p>
          </div>
        </div>
      </div>
    </nav>
