    ...
    <div className="min-h-screen bg-void text-text-secondary antialiased selection:bg-gold/20 selection:text-gold-bright overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 glass-nav transition-all duration-300">
        <div className="flex h-20 max-w-7xl mx-auto px-6 items-center justify-between">
          {/* Logo */}
          <Link href="/landing" className="flex items-center gap-3 group cursor-pointer">
            ...
            <span className="hidden sm:block text-text-primary font-medium">Evolution of Todo</span>
          </Link>
          ...
          <div className="flex items-center gap-6">
            <Link href="/login" className="hidden md:block text-sm font-medium transition-colors text-text-tertiary hover:text-text-primary">
              Sign In
            </Link>
            <Link href="/register" className="px-6 py-2.5 rounded-sm btn-gold text-xs md:text-sm font-semibold tracking-wide uppercase">
              Get Access
            </Link>
          </div>
        </div>
