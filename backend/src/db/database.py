...
# Import UserData model - this is the only model we use now
# Old models (Task, User, ChatMessage) are no longer used - all data is in user_data table
from src.models.user_data import UserData

# DO NOT import old models - they will cause tables to be auto-created
# from src.models.task import Task  # DEPRECATED - causes unwanted table creation
# from src.models.user import User  # DEPRECATED - causes unwanted table creation
